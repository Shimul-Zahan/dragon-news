...
const News = ({ news }) => {
    ...
    // console.log(news)
    const { _id, category_id, image_url, title, total_view, details, } = news;
        ...
        <div>
            <div className='border rounded-lg'>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className='flex items-center gap-4'>
                            <div className="w-10 rounded-full">
                                <img src={news.author.img} className='rounded-full' />
                            </div>
                            <div>
                ...
                <div className='p-5'>
                    ...
                    <p className="text-lg font-medium mt-8">{details.slice(0, 300)} <br /><Link to={`/readmore/${_id}`}><span className='text-yellow-500 font-bold'>Read More</span></Link></p>
